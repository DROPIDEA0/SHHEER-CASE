...
export const timelineEvents = mysqlTable("timeline_events", {
  ...
  title: varchar("title", { length: 300 }).notNull(),
  description: text("description"),
  category: mysqlEnum("category", ["foundation", "investment_deal", "swift_operations", "critical_failure", "legal_proceedings"]).notNull(),
  displayOrder: int("displayOrder").default(0),
...
export const evidenceItems = mysqlTable("evidence_items", {
  ...
  title: varchar("title", { length: 300 }).notNull(),
  description: text("description"),
  category: mysqlEnum("evidenceCategory", ["licenses", "letters", "swift", "documents", "emails", "whatsapp"]).notNull(),
