...
-- With All Updates Including Admin & Site Protection
-- For Hostinger MySQL Database
-- Generated: 2024-12-21
-- =============================================

-- =============================================
-- STEP 1: DROP ALL EXISTING TABLES (Clean Install)
-- =============================================
...
DROP TABLE IF EXISTS `site_access_users`;
DROP TABLE IF EXISTS `site_protection`;

SET FOREIGN_KEY_CHECKS = 1;

-- =============================================
-- STEP 2: CREATE ALL TABLES (Schema)
-- =============================================
...
-- Timeline Events Table (WITH CUSTOM COLOR COLUMNS)
...
INSERT INTO admin_users (username, password, name, email, adminRole, isActive) VALUES 
('admin', '$2b$10$NuUS2VkICv9EvuRLq9pqQOGGTkhbJfUiFE7UPoYlnerMuNB4CD9dO', 'Administrator', 'admin@example.com', 'super_admin', true);

-- Default Site Protection Settings (Disabled by default)
INSERT INTO site_protection (isEnabled, message) VALUES 
(false, 'This site is protected. Please login to continue.');
...
('2005-03-15', NULL, 'SHHEER Project Founded', 'Nesma Barzan Foundation establishes SHHEER mobile advertising platform project.', 'Foundation', NULL, NULL, NULL, 1),
